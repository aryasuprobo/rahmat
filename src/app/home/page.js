...
const HomePage = () => {
    ...
    return (
        <div className="shadow-md rounded-lg bg-gradient-to-r from-blue-700 to-fuchsia-700 italic flex flex-col min-h-screen">
            {/* Header Komponen */}
            <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-lg py-4 mb-8">
            ...
            <div className="pt-20 flex-grow flex items-center justify-center">
                <div className="text-center max-w-lg p-4">
                    ...
                    <button
                        className="px-4 py-2 sm:text-lg max-w-[150px] truncate rounded-full bg-gradient-to-r from-purple-700 to-blue-700 hover:bg-blue-100 transition duration-300 ease-in-out text-lg font-medium shadow-md hover:shadow-lg focus:outline-none hover:scale-105"
